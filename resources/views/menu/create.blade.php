  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row customContainerBox">
        <div class="col-md-12">
          <form method="post" action="{{ route('menu.store') }}" autocomplete="off" enctype="multipart/form-data" class="form-horizontal">
            @csrf
            @method('post')
            <div class="card ">
              <div class="card-header card-header-primary">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Item Name') }}" value="{{ old('name') }}" required="true" aria-required="true"/>
                      @if ($errors->has('name'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" id="input-name" type="text" placeholder="{{ __('Price  with ETB') }}" value="{{ old('price') }}" required="true" aria-required="true"/>
                      @if ($errors->has('price'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <div class="form-group{{ $errors->has('itemsGroupId') ? ' has-danger' : '' }}">
                      ...
                      <option value={{$itemsGroup['itemsGroupId']}}>{{$itemsGroup['name']}}</option>
                        @endforeach
                       </select>
               ...
               <div class="col-md-3">
                    <div>
                          <img id="picturePreview" class="img-thumbnail" alt="Cinque Terre" width="304" height="236">
                    </div>
              </div>
              </div>
