                    ...
                    @foreach($HappyHourMenu as $item)
                        @if ($item->isValid)
                          ...
                          <td class="td-actions text-right">
                              <form action="{{ route('happyHourMenu.destroy', $item) }}" method="post">
                                  @csrf
                                  @method('delete')

                                  <a rel="tooltip" class="btn btn-success btn-link" href="{{ route('happyHourMenu.edit', $item) }}" data-original-title="" title="">
