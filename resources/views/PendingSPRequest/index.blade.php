              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12 text-right">
                    <a href="{{ route('serviceProviders.index') }}" class="btn btn-sm btn-primary">{{ __('Back to Service Providers') }}</a>
                  </div>
                </div>
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      @foreach($PendingSPRequest as $serviceProvider)
                        <tr>
                          <td>
                        ...
                        <a href="{{ route('user.create') }}" class="btn btn-sm btn-primary">{{ __('Add') }}</a>
                          ...
                          <td class="td-actions text-right">
                              <form action="{{ route('PendingSPRequest.destroy', $serviceProvider) }}" method="post">
                                  @csrf
                                  @method('delete')
                                  <a rel="tooltip" class="btn btn-success btn-link" href="{{ route('PendingSPRequest.edit', $serviceProvider) }}" data-original-title="" title="">
